    <div class="container">
                ...
                <div class="ml-auto pr-2 bd-highlight">
                    <a type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#editProfileModal">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="ml-2 mb-1 bi bi-pencil-fill" viewBox="0 0 16 16">
                            <path
        ...
        <!-- ! Modal Isi Laporan -->
        <div class="modal fade" id="isiLaporanModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <!-- ! Laporan -->
        <div class="container d-flex align-items-end flex-column border rounded-lg mt-5 mb-5 shadow"
            style="background-color: white; height: 12vh; background-image: url(../../assets/images/report.jpg); background-size: 65%; background-repeat: no-repeat;">
